...
-- Fetch all WorkOrderEmployees and add Employee Name, which will be displayed in lieu of Employee ID.
...
-- Fetch all PurchaseOrders and add Employee Name, which will be displayed in lieu of Employee ID.
...
-- Fetch all PurchaseOrderItems and add Material Name, which will be displayed in lieu of Material ID.
