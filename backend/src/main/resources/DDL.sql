...
INSERT INTO `WorkOrders`
    (`work_order_id`, `size`, `street`, `city`, `state`, `zip`, `stage`, `applied_at`, `estimated_at`, `scheduled_at`,`started_at`,`completed_at`,`on_hold_at`, `canceled_at`)
VALUES
...
INSERT INTO `Employees`
    (`employee_id`, `first_name`, `last_name`, `email`, `phone_number`, `status`, `skill_level`)
VALUES
...
INSERT INTO `WorkOrderEmployees`
    (`work_order_id`, `employee_id`, `assigned_at`)
VALUES
    (1, (SELECT `employee_id` FROM `Employees` WHERE `first_name` = 'Scott' AND `last_name` = 'Derickson'), '2024-08-04 16:47:56'),
    (1, (SELECT `employee_id` FROM `Employees` WHERE `first_name` = 'Nick' AND `last_name` = 'Anderson'), '2024-08-05 17:46:25'),
    (2, (SELECT `employee_id` FROM `Employees` WHERE `first_name` = 'Aria' AND `last_name` = 'Stark'), '2024-08-21 12:25:25');
...
INSERT INTO `PurchaseOrders`
    (`purchase_order_id`, `created_at`, `employee_id`, `work_order_id`)
VALUES
    (1, '2024-08-01 15:23:53', (SELECT `employee_id` FROM `Employees` WHERE `first_name` = 'Scott' AND `last_name` = 'Derickson'), NULL),
    (2, '2024-08-23 06:23:35', (SELECT `employee_id` FROM `Employees` WHERE `first_name` = 'Luna' AND `last_name` = 'Larson'), 1),
    (3, '2024-08-30 23:34:05', (SELECT `employee_id` FROM `Employees` WHERE `first_name` = 'Luna' AND `last_name` = 'Larson'), 2);
...
INSERT INTO `Materials`
    (`material_id`, `name`, `unit`, `unit_cost`, `quantity_available`)
VALUES
...
INSERT INTO `PurchaseOrderItems`
    (`purchase_order_item_id`, `unit_cost`, `quantity`, `estimated_delivery_date`, `delivery_type`, `purchase_order_id`, `material_id`)
VALUES
    (1, 2.10, 10000, '2024-08-08', 'Ship', 1, (SELECT `material_id` FROM `Materials` WHERE `name` = 'Standard Seamless Eave 6"')),
    (2, 1.24, 10000, '2024-08-08', 'Ship', 1, (SELECT `material_id` FROM `Materials` WHERE `name` = 'Standard Seamless Eave 5"')),
    (3, 5.49, 500, '2024-08-10', 'Ship', 1, (SELECT `material_id` FROM `Materials` WHERE `name` = 'Bolt Fastener Set')),
    (4, 2.10, 286, NULL, 'Stock', 2, (SELECT `material_id` FROM `Materials` WHERE `name` = 'Standard Seamless Eave 6"')),
    (5, 5.56, 22, NULL, 'Stock', 2, (SELECT `material_id` FROM `Materials` WHERE `name` = 'Bolt Fastener Set')),
    (6, 2.15, 118, NULL, 'Stock', 3, (SELECT `material_id` FROM `Materials` WHERE `name` = 'Standard Seamless Eave 6"')),
    (7, 5.56, 16, NULL, 'Stock', 3, (SELECT `material_id` FROM `Materials` WHERE `name` = 'Bolt Fastener Set'));
