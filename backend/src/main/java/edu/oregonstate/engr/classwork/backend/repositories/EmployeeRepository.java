...
public class EmployeeRepository {
    ...
    private final BiFunction<JdbcClient.StatementSpec, Employee, JdbcClient.StatementSpec> statementMapper;
    ...
    public EmployeeRepository(DataSource dataSource) {
        ...
        this.statementMapper = (statementSpec, employee) -> {
    ...
    public int insert(Employee employee) {
        ...
        statementMapper.apply(jdbcClient.sql(sql), employee).update(keyHolder);
